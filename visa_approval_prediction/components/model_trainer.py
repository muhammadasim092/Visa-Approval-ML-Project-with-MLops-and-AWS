...
from visa_approval_prediction.utils.main_utils import load_numpy_array_data, real_yaml_files, load_objects, save_object
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, ) -> ModelTrainerArtifact:
        ...
        try:
            ...
            preprocessing_obj = load_objects(file_path=self.data_transformation_artifact.transformed_object_file_path)
